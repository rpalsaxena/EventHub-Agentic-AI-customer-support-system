...
@tool
def get_user_reservations(user_id: str, status: Optional[str] = None, limit: int = 10) -> List[Dict[str, Any]]:
    """
...
@tool
def get_user_tickets(user_id: str, status: Optional[str] = None, limit: int = 10) -> List[Dict[str, Any]]:
    """
